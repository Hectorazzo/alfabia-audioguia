...
const COPY = {
  es: {
    ...
    eventsContact:   'Solicitar información',
  ...
  en: {
    ...
    eventsContact:   'Request information',
  ...
  de: {
    ...
    eventsContact:   'Informationen anfragen',
  ...
  ca: {
    ...
    eventsContact:   'Sol·licitar informació',
  ...
  fr: {
    ...
    eventsContact:   'Demander des informations',
